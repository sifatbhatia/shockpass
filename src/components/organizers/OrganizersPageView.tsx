    ...
    <AppShell heroUnderNav>
      <div ref={rootRef} className="bg-bg">
        ...
        <section className="relative -mt-[var(--nav-bar-height,4.5rem)] min-h-[100dvh] overflow-hidden grain-overlay">
          ...
          <div className="relative mx-auto flex min-h-[100dvh] max-w-[1650px] flex-col items-center justify-center px-4 pt-[calc(var(--nav-bar-height,4.5rem)+1rem)] sm:px-6">
            <div className="flex flex-col items-center text-center max-w-3xl">
              ...
              <div data-org-hero className="mt-6 flex items-center justify-center gap-3">
                ...
                <Button href="/events" variant="ghost" className="flex-1 sm:flex-none text-muted hover:text-text whitespace-nowrap">
                  See buyer side →
                </Button>
              </div>
            </div>
